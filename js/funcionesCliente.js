function autoInicioCliente(){
    ...
    $.ajax({
        url:"http://129.151.125.69:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCliente(){
    let var2 = {
        ...
        url:"http://129.151.125.69:8080/api/Client/save",
...
function actualizarInformacionCliente(idElemento){
    ...
    $.ajax({
        url:"http://129.151.125.69:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCliente(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.125.69:8080/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
